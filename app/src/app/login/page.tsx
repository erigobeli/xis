        ...
        {!isSignUp ? (
          <>
            ...
            {!isSupabaseConfigured && (
              <div className="max-w-[300px] mb-5 rounded-2xl border border-yellow-700/60 bg-yellow-500/10 px-4 py-3 text-[13px] text-yellow-200">
                Configure `NEXT_PUBLIC_SUPABASE_URL` e `NEXT_PUBLIC_SUPABASE_ANON_KEY` em `app/.env.local` para usar login e carregar os dados.
              </div>
            )}
          ...
          <>
            ...
            {!isSupabaseConfigured && (
              <div className="max-w-[300px] mb-5 rounded-2xl border border-yellow-700/60 bg-yellow-500/10 px-4 py-3 text-[13px] text-yellow-200">
                Configure `NEXT_PUBLIC_SUPABASE_URL` e `NEXT_PUBLIC_SUPABASE_ANON_KEY` em `app/.env.local` para habilitar cadastro e autenticação.
              </div>
            )}
